              ...
              <div class="products-category__list">
                ...
                <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="products-category__list__item">
                            <div class="products-category__list__item__title-product"><a href="<?php echo e(route('product',['id'=>$item->id])); ?>"><?php echo e($item->title); ?></a></div>
                            <div class="products-category__list__item__thumbnail"><a href="<?php echo e(route('product',['id'=>$item->id])); ?>" class="products-category__list__item__thumbnail__link"><img src="img/cover/game-6.jpg" alt="Preview-image"></a></div>
                            <div class="products-category__list__item__description"><span class="products-price"><?php echo e($item->price); ?></span><a href="<?php echo e(route('buy',['id'=>$item->id])); ?>" class="btn btn-blue">Купить</a></div>
                        </div>
